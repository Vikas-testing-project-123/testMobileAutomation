...
// Try our demo app
		...
		System.out.println("Application started...");
			...
			FooterRSM.click();
			Thread.sleep(10000);
			MobileElement RSMcard = (MobileElement)driver.findElementByXPath("");
			...
			//sorting
			MobileElement sort_icon1 = (MobileElement)driver.findElementByXPath("");
			sort_icon1.click();
			
			// descending flow 
			Thread.sleep(2000);
			MobileElement Desc1 = (MobileElement)driver.findElementByXPath("");
			Desc1.click();
			Thread.sleep(2000);
			MobileElement Outsort1 = (MobileElement)driver.findElementByXPath("");
			Outsort1.click();
			Thread.sleep(2000);
			String BUsort1 = driver.findElementByXPath("").getText();
			Thread.sleep(4000);
			...
			sort_icon1.click();
			Thread.sleep(3000);
			MobileElement Amount1 = (MobileElement)driver.findElementByXPath("");
			Amount1.click();
			Thread.sleep(4000);
			MobileElement Outsort1_1 = (MobileElement)driver.findElementByXPath("");
			Outsort1_1.click();
			Thread.sleep(5000);
...
//			}
			...
			String amtfil = driver.findElementByXPath("").getText();
			...
			sort_icon1.click();
			Thread.sleep(3000);
			MobileElement Ast1 = (MobileElement)driver.findElementByXPath("");
			Ast1.click();
			Thread.sleep(3000);
			MobileElement Name1 = (MobileElement)driver.findElementByXPath("");
			Name1.click();
			Thread.sleep(2000);
			MobileElement Outsort1_3 = (MobileElement)driver.findElementByXPath("");
			Outsort1_3.click();
			Thread.sleep(4000);
...
//salesperson
			...
			Thread.sleep(10000);
			String Salesperson = driver.findElementByXPath("").getText();
...
//sorting
			MobileElement sort_icon2 = (MobileElement)driver.findElementByXPath("");
			sort_icon2.click();
			
// descending flow 
			Thread.sleep(3000);
			MobileElement Desc2 = (MobileElement)driver.findElementByXPath("");
			Desc2.click();
			Thread.sleep(6000);
			MobileElement Outsort2 = (MobileElement)driver.findElementByXPath("");
			Outsort2.click();
			Thread.sleep(2000);
			String BUsort2 = driver.findElementByXPath("").getText();
			Thread.sleep(4000);
			...
			sort_icon2.click();
			Thread.sleep(2000);
			MobileElement Amount2 = (MobileElement)driver.findElementByXPath("");
			Amount2.click();
			Thread.sleep(2000);
			MobileElement outsort2_1 = (MobileElement)driver.findElementByXPath("");
			outsort2_1.click();
			Thread.sleep(2000);
			
//			String BUsortamount2_1 = driver.findElementByXPath("").getText();
//			int BUamt2_1 = Integer.parseInt(BUsortamount2_1);
//			String BUsortamount2_2 = driver.findElementByXPath("").getText();
...
//			}
			...
			String amtfil2 = driver.findElementByXPath("").getText();
...
//Set to default			
			sort_icon2.click();
			Thread.sleep(2000);
			MobileElement Ast2 = (MobileElement)driver.findElementByXPath("");
			Ast2.click();
			Thread.sleep(2000);
			MobileElement Name2 = (MobileElement)driver.findElementByXPath("");
			Name2.click();
			Thread.sleep(2000);
			MobileElement Outsort2_2 = (MobileElement)driver.findElementByXPath("");
			Outsort2_2.click();
			Thread.sleep(4000);
...
//customer
			...
			Thread.sleep(10000);
			String customer = driver.findElementByXPath("").getText();
...
//			Sorting flow
			MobileElement sort_icon3 = (MobileElement)driver.findElementByXPath("");
			sort_icon3.click();
			
// descending flow 
			Thread.sleep(5000);
			MobileElement Desc3 = (MobileElement)driver.findElementByXPath("");
			Desc3.click();
			Thread.sleep(5000);
			MobileElement Outsort3 = (MobileElement)driver.findElementByXPath("");
			Outsort3.click();
			Thread.sleep(5000);
			String BUsort3 = driver.findElementByXPath("").getText();
			Thread.sleep(5000);
			...
			sort_icon3.click();
			Thread.sleep(10000);
			MobileElement Amount3 = (MobileElement)driver.findElementByXPath("");
			Amount3.click();
			Thread.sleep(2000);
			MobileElement Outsort3_1 = (MobileElement)driver.findElementByXPath("");
			Outsort3_1.click();
			Thread.sleep(5000);
...
//			}
			...
			String amtfil3 = driver.findElementByXPath("").getText();
			...
			MobileElement Ast3 = (MobileElement)driver.findElementByXPath("");
			Ast3.click();
			Thread.sleep(5000);
			MobileElement Name3 = (MobileElement)driver.findElementByXPath("");
			Name3.click();
			Thread.sleep(5000);
			MobileElement Outsort3_2 = (MobileElement)driver.findElementByXPath("");
			Outsort3_2.click();
			Thread.sleep(5000);
